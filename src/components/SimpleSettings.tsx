    ...
    <div className="flex-1 p-8 max-w-4xl mx-auto">
      ...
      <Card className="bg-purple-900/20 backdrop-blur border-purple-500/30">
        <CardHeader>
          ...
          <p className="text-gray-300">AI servislerine bağlanmak için API anahtarlarınızı girin</p>
        </CardHeader>
        <CardContent className="space-y-6">
          {/* Test Mode Button */}
          <div className="bg-blue-500/10 border border-blue-400/30 rounded-lg p-4">
            <h4 className="text-blue-300 font-semibold mb-2">🧪 Test Modu</h4>
            <p className="text-blue-200 text-sm mb-3">
              API key'iniz yoksa test etmek için aşağıdaki butonu kullanın.
            </p>
            <Button 
              onClick={handleTestKeys}
              className="bg-blue-500/20 hover:bg-blue-500/30 text-blue-200 border border-blue-400/50"
            >
              🚀 Test API Key'leri Ekle
            </Button>
          </div>
          ...
          <div className="bg-green-500/10 border border-green-400/30 rounded-lg p-4">
            <p className="text-green-200 text-sm">
              🔒 API anahtarları sadece tarayıcınızda yerel olarak saklanır ve hiçbir yere gönderilmez.
            </p>
          </div>
